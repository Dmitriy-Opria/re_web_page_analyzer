...
// Conflicts with log.Panic(...)
var GomegaPanic = gomega.Panic
...
var FDescribeTable = table.FDescribeTable
var PDescribeTable = table.PDescribeTable
var XDescribeTable = table.XDescribeTable
var Entry = table.Entry
var FEntry = table.FEntry
var PEntry = table.PEntry
var XEntry = table.XEntry
